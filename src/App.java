...
public class App {
    public static void app(){
        ...
        executionHistories.add(new ExecutionHistory("user", "こんにちは","", ""));
        executionHistories.add(new ExecutionHistory("assistant", "こんにちは！実行したい操作はなんですか？","", ""));
        executionHistories.add(new ExecutionHistory("user", "hello world, hello linux osと出力するコマンド","", ""));
        ...
        ScriptExecuter.executeScript(scriptPath,openaiText);
    }
}
